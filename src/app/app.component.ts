...
import { SpaceXLaunch } from './services/launch/spacex-launch.modal';
...
export class AppComponent {
  ...
  allSpaceXLaunches: Array<SpaceXLaunch> = [];
  ...
  private getAllLaunchesData(): void {
    ...
    this.allLaunchesSubscription = this.launchService.getAllLaunches(options).subscribe((response: Array<SpaceXLaunch>) => {
      this.loading = false;
